package com.yzsunlei.xmall.admin.component;

import com.yzsunlei.xmall.admin.bo.WebLog;
import com.yzsunlei.xmall.admin.util.JsonUtil;
import com.yzsunlei.xmall.admin.util.RequestUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("execution(public * com.yzsunlei.xmall.controller.*.*(..))")
    public void webLog() {
    }
