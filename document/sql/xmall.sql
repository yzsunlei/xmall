...
CREATE TABLE `cms_help`  (
  ...
  `read_count` int(11) NULL DEFAULT NULL COMMENT '浏览次数',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `show_status` int(1) NULL DEFAULT NULL COMMENT '显示状态',
...
CREATE TABLE `cms_help_category`  (
  ...
  `help_count` int(11) NULL DEFAULT NULL COMMENT '分类数量',
...
CREATE TABLE `cms_member_report`  (
  ...
  `report_member_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '举报人名称',
  `report_object` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '举报内容',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `cms_prefrence_area_product_relation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `prefrence_area_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的优选专区',
  `product_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的产品',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `prefrence_area_id`(`prefrence_area_id`) USING BTREE,
...
CREATE TABLE `cms_subject`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `category_id` bigint(20) NULL DEFAULT NULL COMMENT '专题分类id',
  `category_name` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '专题分类名称',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '专题名称',
  `pic` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '专题主图',
  `description` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '专题描述',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '专题详情',
  ...
  `recommend_status` int(1) NULL DEFAULT NULL COMMENT '推荐状态',
  `collect_count` int(11) NULL DEFAULT NULL COMMENT '收藏次数',
  `read_count` int(11) NULL DEFAULT NULL COMMENT '浏览次数',
...
CREATE TABLE `cms_subject_comment`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `subject_id` bigint(20) NOT NULL COMMENT '关联的专题',
  `member_nick_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '评论用户',
...
CREATE TABLE `cms_subject_product_relation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `subject_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的专题',
  `product_id` bigint(20) NULL DEFAULT NULL COMMENT '关联的商品',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `subject_id`(`subject_id`) USING BTREE,
  INDEX `product_id`(`product_id`) USING BTREE
...
CREATE TABLE `cms_topic`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `category_id` bigint(20) NULL DEFAULT NULL COMMENT '话题分类',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '话题名称',
...
CREATE TABLE `cms_topic_category`  (
  ...
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分类名称',
  `icon` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类图标',
  `subject_count` int(11) NULL DEFAULT NULL COMMENT '话题数量',
  `sort` int(11) NULL DEFAULT NULL COMMENT '排序',
  `show_status` int(1) NULL DEFAULT NULL COMMENT '显示状态',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `cms_topic_comment`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `topic_id` bigint(20) NULL DEFAULT NULL COMMENT '参与话题',
  `member_nick_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '参与用户名',
  `member_icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参与用户头像',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '话题评论表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `oms_cart_item`  (
  ...
  `product_sku_id` bigint(20) NULL DEFAULT NULL COMMENT '关联商品sku',
...
CREATE TABLE `oms_order`  (
  ...
  `promotion_amount` decimal(10, 2) NULL DEFAULT NULL COMMENT '促销优惠金额（促销价、满减、阶梯价）',
...
CREATE TABLE `oms_order_item`  (
  ...
  `product_pic` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品主图',
  ...
  `sp2` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品的销售属性2',
  `sp3` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品的销售属性3',
  ...
  `gift_integration` int(11) NULL DEFAULT 0 COMMENT '奖励积分',
  `gift_growth` int(11) NULL DEFAULT 0 COMMENT '奖励成长值',
  `product_attr` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品销售属性:[{\"key\":\"颜色\",\"value\":\"颜色\"},{\"key\":\"容量\",\"value\":\"4G\"}]',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `pms_comment_reply`  (
  ...
  `member_id` bigint(20) NULL DEFAULT NULL COMMENT '回复用户id',
  `member_nick_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回复用户名称',
  `member_icon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '回复用户头像',
...
INSERT INTO `ums_admin` VALUES (3, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/images/20180607/timg.jpg', 'admin@163.com', '系统管理员', '系统管理员', '2018-10-08 13:32:47', '2019-04-07 10:22:53', 1);
...
-- ----------------------------
INSERT INTO `ums_admin_login_log` VALUES (1, 3, '2019-03-06 21:09:14', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (2, 3, '2019-04-07 09:53:28', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (3, 3, '2019-04-07 09:54:51', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (4, 3, '2019-04-07 09:56:29', '0:0:0:0:0:0:0:1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (5, 3, '2019-04-07 10:22:53', '0:0:0:0:0:0:0:1', NULL, NULL);
...
CREATE TABLE `ums_admin_role_permission_relation`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `role_id` bigint(20) NULL DEFAULT NULL COMMENT '用户角色id',
...
-- ----------------------------
-- Table structure for ums_member_growth_change_history
-- ----------------------------
...
-- ----------------------------
-- Table structure for ums_member_integration_change_history
-- ----------------------------
...
-- ----------------------------
-- Table structure for ums_member_integration_consume_setting
-- ----------------------------
